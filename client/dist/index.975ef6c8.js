...
var _map = require("./pages/map");
var _currency = require("./pages/currency");
var _accountId = require("./pages/accountId");
var _account = require("./pages/account");
var _mapStore = require("./store/mapStore");
var _modalOops = require("./components/ModalOops/ModalOops");
var _currencyStore = require("./store/currencyStore");
var _transactionsHistory = require("./pages/transactions-history");
...
router.on("/account", async function() {
    if (localStorage.getItem("token")) {
        document.body.innerHTML = "";
        await (0, _account.accountPage)();
    } else router.navigate("/auth");
}).resolve();
router.on("/account/:id", async function() {
    if (localStorage.getItem("token")) {
        document.body.innerHTML = "";
        (0, _accountId.accountIdPage)();
    } else router.navigate("/auth");
}).resolve();
router.on("/account/:id/transactions-history", function() {
    if (localStorage.getItem("token")) {
        document.body.innerHTML = "";
        (0, _transactionsHistory.transactionsHistoryPage)();
    } else router.navigate("/auth");
}).resolve();
router.on("/available-currency", async function() {
    if (localStorage.getItem("token")) {
        document.body.innerHTML = "";
        await (0, _currency.currencyPage)();
    } else router.navigate("/auth");
    if ((0, _currencyStore.currencyStore).status !== 200) (0, _modalOops.ModalOops)();
}).resolve();
router.on("/banks-map", async function() {
    if (localStorage.getItem("token")) {
        document.body.innerHTML = "";
        await (0, _map.mapPage)();
    } else router.navigate("/auth");
    if ((0, _mapStore.points).status !== 200) (0, _modalOops.ModalOops)();
}).resolve();

},{"navigo":"fuSlc","./pages/auth":"5X8yS","./pages/map":"1IsWo","./pages/currency":"gzlTW","./pages/accountId":"fRYv2","./pages/account":"7jREJ","./store/mapStore":"TNSsq","./components/ModalOops/ModalOops":"9SwD6","./store/currencyStore":"2u2TR","./pages/transactions-history":"fsqSO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fuSlc":[function(require,module,exports) {
!function(t, n) {
    module.exports = n();
...
},{}],"5X8yS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "authPage", ()=>authPage);
var _header = require("../components/Header/Header");
var _auth = require("../modules/Auth/Auth");
var _myViewModal = require("../UI/MyViewModal/MyViewModal");
const authPage = ()=>{
    const header = (0, _header.Header)();
    const main = (0, _auth.Auth)();
    document.body.appendChild(header);
    document.body.appendChild(main);
    document.body.append((0, _myViewModal.MyViewModal)());
};

},{"../components/Header/Header":"8iwn3","../modules/Auth/Auth":"7YTBi","../UI/MyViewModal/MyViewModal":"1z50T","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8iwn3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Header", ()=>Header);
var _myContainer = require("../../UI/MyContainer/MyContainer");
var _headerScss = require("./header.scss");
const Header = (nav = "")=>{
    const header = document.createElement("header");
    const container = (0, _myContainer.MyContainer)();
...
},{"../../UI/MyContainer/MyContainer":"jpOMq","./header.scss":"d5KI4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jpOMq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MyContainer", ()=>MyContainer);
var _mycontainerScss = require("./mycontainer.scss");
const MyContainer = ()=>{
...
},{"./mycontainer.scss":"5vNRT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5vNRT":[function() {},{}],"gkKU3":[function(require,module,exports) {
...
},{}],"d5KI4":[function() {},{}],"7YTBi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Auth", ()=>Auth);
var _authForm = require("../Auth/AuthForm/AuthForm");
var _myContainer = require("../../UI/MyContainer/MyContainer");
var _authScss = require("./auth.scss");
const Auth = ()=>{
    const main = document.createElement("main");
    const container = (0, _myContainer.MyContainer)();
    const authForm = (0, _authForm.AuthForm)();
...
},{"../Auth/AuthForm/AuthForm":"grBVK","../../UI/MyContainer/MyContainer":"jpOMq","./auth.scss":"2CM8c","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"grBVK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AuthForm", ()=>AuthForm);
var _form = require("../../../components/Form/Form");
var _authformScss = require("./authform.scss");
const AuthForm = ()=>{
    const form = (0, _form.Form)();
    form.classList.add("form");
    return form;
};

},{"../../../components/Form/Form":"aSFvk","./authform.scss":"kiuCo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aSFvk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Form", ()=>Form);
var _myButton = require("../../UI/MyButton/MyButton");
var _myInput = require("../../UI/MyInput/MyInput");
var _myTitle = require("../../UI/MyTitle/MyTitle");
var _myLabel = require("../../UI/MyLabel/MyLabel");
var _validateField = require("./helpers/validateField");
var _errorField = require("./components/errorField/ErrorField");
var _authorization = require("./api/authorization");
var _authStore = require("../../store/authStore");
var _redirect = require("./helpers/redirect");
var _formScss = require("./form.scss");
const Form = ()=>{
    const btn = (0, _myButton.MyButton)("Войти", "submit");
    const login = (0, _myInput.MyInput)("Логин");
    const labelLogin = (0, _myLabel.MyLabel)("Логин");
    const labelPassword = (0, _myLabel.MyLabel)("Пароль");
    const password = (0, _myInput.MyInput)("Пароль");
    const title = (0, _myTitle.MyTitle)("Вход в аккаунт");
    ...
    btn.addEventListener("click", async ()=>{
        ...
        if (errorFields.length) errorFields.forEach((error)=>error.remove());
        const [loginLength, loginSpace] = (0, _validateField.validateField)(login.value);
        const [passwordLength, passwordSpace] = (0, _validateField.validateField)(password.value);
        if (!loginLength) {
            const errorField = (0, _errorField.ErrorField)("Не менее 6 символов");
        ...
        if (!loginSpace) {
            const errorField = (0, _errorField.ErrorField)("Строка не должна содержать пробелов");
            login.classList.add("errorBorder");
            wrapperLogin.append(errorField);
        }
        if (!passwordSpace) {
        ...
        if (loginLength && loginSpace && passwordSpace && passwordLength) {
            const { token , error  } = await (0, _authorization.authUser)(login.value, password.value);
            (0, _authStore.authStore).token = token;
            (0, _authStore.authStore).error = error;
            (0, _redirect.redirect)();
        }
    });
...
},{"../../UI/MyButton/MyButton":"4PoHU","../../UI/MyInput/MyInput":"5qHQO","../../UI/MyTitle/MyTitle":"kQpK7","../../UI/MyLabel/MyLabel":"1R4ea","./helpers/validateField":"gTAs4","./components/errorField/ErrorField":"e82EY","./api/authorization":"13n6F","../../store/authStore":"1oQg6","./helpers/redirect":"cu05D","./form.scss":"8fSUX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4PoHU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MyButton", ()=>MyButton);
var _mybuttonScss = require("./mybutton.scss");
const MyButton = (title, type = "button", svg = "")=>{
...
},{"./mybutton.scss":"80yXr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"80yXr":[function() {},{}],"5qHQO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MyInput", ()=>MyInput);
var _myinputScss = require("./myinput.scss");
...
},{"./myinput.scss":"lRlaM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lRlaM":[function() {},{}],"kQpK7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MyTitle", ()=>MyTitle);
var _mytitleScss = require("./mytitle.scss");
const MyTitle = (title)=>{
...
},{"./mytitle.scss":"jMcm7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jMcm7":[function() {},{}],"1R4ea":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MyLabel", ()=>MyLabel);
var _mylabelScss = require("./mylabel.scss");
const MyLabel = (title)=>{
...
},{"./mylabel.scss":"EVJgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"EVJgQ":[function() {},{}],"gTAs4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const validateField = (value)=>{
    ...
    const space = value.match((0, _regex.regex).validationSpace);
    return [
        minLength,
        !!space
    ];
...
},{"../../../shared/regex":"RO9jt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"RO9jt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e82EY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ErrorField", ()=>ErrorField);
var _errorfieldScss = require("./errorfield.scss");
...
},{"./errorfield.scss":"7EDfX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7EDfX":[function() {},{}],"13n6F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "authUser", ()=>authUser);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../services/url.config");
var _spinner = require("../../Spinner/Spinner");
const authUser = async (login, password)=>{
    const spinner = (0, _spinner.Spinner)();
    document.body.append(spinner);
    try {
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/login`, {
            method: "POST",
            headers: {
...
},{"axios":"jo6P5","../../../services/url.config":"aF1eV","../../Spinner/Spinner":"aqKi8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var Buffer = require("41b3b933070c9b77").Buffer;
"use strict";
/**
...
},{"41b3b933070c9b77":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("f2512d975204ea3a");
var ieee754 = require("930d5204aa29d847");
...
},{"f2512d975204ea3a":"eIiSV","930d5204aa29d847":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aF1eV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "baseUrl", ()=>baseUrl);
const baseUrl = "http://localhost:3000";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aqKi8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./spinner.scss":"i2xZt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i2xZt":[function() {},{}],"1oQg6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "authStore", ()=>authStore);
const authStore = {
    token: "",
    error: ""
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cu05D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "redirect", ()=>redirect);
var _myModal = require("../../../UI/MyModal/MyModal");
var _authStore = require("../../../store/authStore");
var _spinner = require("../../Spinner/Spinner");
var _ = require("../../..");
const redirect = ()=>{
    if ((0, _authStore.authStore).token) {
        document.body.innerHTML = "";
        const spinner = (0, _spinner.Spinner)();
        const modal = (0, _myModal.MyModal)("Вы авторизовались", "success");
        modal.style.position = "absolute";
        modal.style.top = "20px";
        modal.style.right = "20px";
        document.body.append(modal);
        document.body.append(spinner);
        localStorage.setItem("token", (0, _authStore.authStore).token.token);
        setTimeout(()=>{
            spinner.remove();
            (0, _.router).navigate("/account");
        }, 3000);
    } else if ((0, _authStore.authStore).error === "Invalid password") {
        const modal = (0, _myModal.MyModal)("Неверный пароль", "error");
        const modalView = document.querySelector(".block");
        modalView.append(modal);
    } else if ((0, _authStore.authStore).error === "No such user") {
        const modal = (0, _myModal.MyModal)("Такого пользователя не существует", "error");
        const modalView = document.querySelector(".block");
        modalView.append(modal);
    } else {
        const modal = (0, _myModal.MyModal)("Упс... Попробуйте позже", "error");
        const modalView = document.querySelector(".block");
        modalView.append(modal);
    }
};

},{"../../../UI/MyModal/MyModal":"squGM","../../../store/authStore":"1oQg6","../../Spinner/Spinner":"aqKi8","../../..":"8lqZg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"squGM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MyModal", ()=>MyModal);
var _mymodalScss = require("./mymodal.scss");
const MyModal = (message, type = "success")=>{
...
},{"./mymodal.scss":"QCjzF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"QCjzF":[function() {},{}],"8fSUX":[function() {},{}],"kiuCo":[function() {},{}],"2CM8c":[function() {},{}],"1z50T":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MyViewModal", ()=>MyViewModal);
var _myviewmodalScss = require("./myviewmodal.scss");
const MyViewModal = ()=>{
...
},{"./myviewmodal.scss":"lvSru","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lvSru":[function() {},{}],"1IsWo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mapPage", ()=>mapPage);
var _myViewModal = require("../UI/MyViewModal/MyViewModal");
var _header = require("../components/Header/Header");
var _navbar = require("../components/Navbar/Navbar");
var _banksMap = require("../modules/BanksMap/BanksMap");
const mapPage = async ()=>{
    const navbar = (0, _navbar.Navbar)("banks-map");
    const header = (0, _header.Header)(navbar);
    const main = await (0, _banksMap.BanksMap)();
    document.body.append(header, main);
    document.body.append((0, _myViewModal.MyViewModal)());
};

},{"../UI/MyViewModal/MyViewModal":"1z50T","../components/Header/Header":"8iwn3","../components/Navbar/Navbar":"2oTCt","../modules/BanksMap/BanksMap":"8Zvrd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2oTCt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Navbar", ()=>Navbar);
var _myButtonLink = require("../../UI/MyButtonLink/MyButtonLink");
var _navbarScss = require("./navbar.scss");
const Navbar = (activeBtn = "")=>{
    const navbar = document.createElement("nav");
    const ATMs = (0, _myButtonLink.MyButtonLink)("Банкоматы", "banks-map");
    const accounts = (0, _myButtonLink.MyButtonLink)("Счета", "account");
    const currency = (0, _myButtonLink.MyButtonLink)("Валюта", "available-currency");
    const exit = (0, _myButtonLink.MyButtonLink)("Выйти", "auth");
...
},{"../../UI/MyButtonLink/MyButtonLink":"d65BK","./navbar.scss":"4Yj7K","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d65BK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MyButtonLink", ()=>MyButtonLink);
var _mybuttonlinkScss = require("./mybuttonlink.scss");
var _ = require("../..");
const MyButtonLink = (title, path = "account")=>{
    const btn = document.createElement("button");
    btn.classList.add("link", "btn-reset");
    btn.type = "button";
    btn.textContent = title;
    btn.addEventListener("click", ()=>{
        (0, _.router).navigate(`/${path}`);
    });
    return btn;
};

},{"./mybuttonlink.scss":"eSfOI","../..":"8lqZg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eSfOI":[function() {},{}],"4Yj7K":[function() {},{}],"8Zvrd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BanksMap", ()=>BanksMap);
var _myContainer = require("../../UI/MyContainer/MyContainer");
var _myTitle = require("../../UI/MyTitle/MyTitle");
var _yandexMap = require("./Map/YandexMap");
var _banksmapScss = require("./banksmap.scss");
const BanksMap = async ()=>{
    const main = document.createElement("main");
    const title = (0, _myTitle.MyTitle)("Карта банкоматов");
    const map = await (0, _yandexMap.YandexMap)();
    const container = (0, _myContainer.MyContainer)();
...
},{"../../UI/MyContainer/MyContainer":"jpOMq","../../UI/MyTitle/MyTitle":"kQpK7","./Map/YandexMap":"1oxLB","./banksmap.scss":"lesXr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1oxLB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "YandexMap", ()=>YandexMap);
var _getPointsBanks = require("./api/getPointsBanks");
var _mapStore = require("../../../store/mapStore");
var _yandexmapScss = require("./yandexmap.scss");
const YandexMap = async ()=>{
    const points = await (0, _getPointsBanks.getPointsBanks)();
    (0, _mapStore.points).data = points.data;
    (0, _mapStore.points).status = points.status;
...
function addPointonMap(map, lat, lon) {
    const bank = new ymaps.Placemark([
        lat,
        lon
    ]);
...
},{"./api/getPointsBanks":"25WVI","../../../store/mapStore":"TNSsq","./yandexmap.scss":"3P1St","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"25WVI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getPointsBanks", ()=>getPointsBanks);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../../services/url.config");
var _spinner = require("../../../../components/Spinner/Spinner");
const getPointsBanks = async ()=>{
    const spinner = (0, _spinner.Spinner)();
    document.body.append(spinner);
    try {
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/banks`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
...
},{"axios":"jo6P5","../../../../services/url.config":"aF1eV","../../../../components/Spinner/Spinner":"aqKi8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"TNSsq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3P1St":[function() {},{}],"lesXr":[function() {},{}],"gzlTW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "currencyPage", ()=>currencyPage);
var _header = require("../components/Header/Header");
var _navbar = require("../components/Navbar/Navbar");
var _currency = require("../modules/Currency/Currency");
var _myViewModal = require("../UI/MyViewModal/MyViewModal");
const currencyPage = async ()=>{
    const navbar = (0, _navbar.Navbar)("available-currency");
    const header = (0, _header.Header)(navbar);
    const main = await (0, _currency.Currency)();
    document.body.append(header, main);
    document.body.append((0, _myViewModal.MyViewModal)());
};

},{"../components/Header/Header":"8iwn3","../components/Navbar/Navbar":"2oTCt","../modules/Currency/Currency":"aCyGc","../UI/MyViewModal/MyViewModal":"1z50T","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aCyGc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Currency", ()=>Currency);
var _myContainer = require("../../UI/MyContainer/MyContainer");
var _myTitle = require("../../UI/MyTitle/MyTitle");
var _getCurrencyUser = require("./api/getCurrencyUser");
var _currencyBlock = require("../../components/CurrencyBlock/CurrencyBlock");
var _webSocketBlock = require("./WebSocketBlock/WebSocketBlock");
var _currencyStore = require("../../store/currencyStore");
var _bureau = require("./Bureau/Bureau");
var _currencyScss = require("./currency.scss");
const Currency = async ()=>{
    const currencies = await (0, _getCurrencyUser.getCurrencyUser)();
    (0, _currencyStore.currencyStore).data = currencies.data;
    (0, _currencyStore.currencyStore).status = currencies.error;
    const main = document.createElement("main");
    const currencyWrapper = document.createElement("div");
    const mycurrencyWrapper = document.createElement("div");
    const mycurrencyAccounts = (0, _currencyBlock.CurrencyBlock)("Ваши валюты", currencies.data);
    const bureau = (0, _bureau.Bureau)();
    const title = (0, _myTitle.MyTitle)("Валютный обмен");
    const container = (0, _myContainer.MyContainer)();
    const realTimeCurrency = (0, _webSocketBlock.WebSocketBlock)();
...
},{"../../UI/MyContainer/MyContainer":"jpOMq","../../UI/MyTitle/MyTitle":"kQpK7","./api/getCurrencyUser":"2VIq7","../../components/CurrencyBlock/CurrencyBlock":"cCZlT","./WebSocketBlock/WebSocketBlock":"3upNg","../../store/currencyStore":"2u2TR","./Bureau/Bureau":"gdoqH","./currency.scss":"lY5z9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2VIq7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCurrencyUser", ()=>getCurrencyUser);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../services/url.config");
var _spinner = require("../../../components/Spinner/Spinner");
const getCurrencyUser = async ()=>{
    ...
    document.body.append(spinner);
    try {
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/currencies`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Basic ${localStorage.getItem("token")}`
...
},{"axios":"jo6P5","../../../services/url.config":"aF1eV","../../../components/Spinner/Spinner":"aqKi8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cCZlT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CurrencyBlock", ()=>CurrencyBlock);
var _myTitle = require("../../UI/MyTitle/MyTitle");
var _currencyblockScss = require("./currencyblock.scss");
const CurrencyBlock = (name, currencyAccounts = [])=>{
    const block = document.createElement("div");
    const title = (0, _myTitle.MyTitle)(name);
...
},{"../../UI/MyTitle/MyTitle":"kQpK7","./currencyblock.scss":"6ouMd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6ouMd":[function() {},{}],"3upNg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WebSocketBlock", ()=>WebSocketBlock);
var _ = require("../../..");
var _realTimeCurrencyBlock = require("../../../components/RealTimeCurrencyBlock/RealTimeCurrencyBlock");
const WebSocketBlock = ()=>{
    ...
    let block = (0, _realTimeCurrencyBlock.RealTimeCurrencyBlock)("Изменение курсов в реальном времени", current);
    (0, _.socket).onmessage = function(e) {
        ...
        (0, _realTimeCurrencyBlock.createCurrencyAccount)(currencyWrapper, blockRate);
    };
    return block;
};

},{"../../..":"8lqZg","../../../components/RealTimeCurrencyBlock/RealTimeCurrencyBlock":"gPzCr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gPzCr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "RealTimeCurrencyBlock", ()=>RealTimeCurrencyBlock);
parcelHelpers.export(exports, "createCurrencyAccount", ()=>createCurrencyAccount);
var _myTitle = require("../../UI/MyTitle/MyTitle");
var _realtimecurrencyblockScss = require("./realtimecurrencyblock.scss");
const RealTimeCurrencyBlock = (name, currencyAccounts = [])=>{
    const block = document.createElement("div");
    const title = (0, _myTitle.MyTitle)(name);
    const rate = document.createElement("div");
...
function createCurrencyAccount(arrAccounts, container) {
...
},{"../../UI/MyTitle/MyTitle":"kQpK7","./realtimecurrencyblock.scss":"iNHUV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iNHUV":[function() {},{}],"2u2TR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "currencyStore", ()=>currencyStore);
parcelHelpers.export(exports, "swapCurrencyStore", ()=>swapCurrencyStore);
const currencyStore = {
    data: {
        title: "",
        value: ""
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gdoqH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Bureau", ()=>Bureau);
var _myTitle = require("../../../UI/MyTitle/MyTitle");
var _mySelector = require("../../../UI/MySelector/MySelector");
var _myInput = require("../../../UI/MyInput/MyInput");
var _myButton = require("../../../UI/MyButton/MyButton");
var _currencyStore = require("../../../store/currencyStore");
var _swapCurrency = require("../api/swapCurrency");
var _processingResp = require("./helpers/processingResp");
var _bureauScss = require("./bureau.scss");
const Bureau = ()=>{
    const currencies = [];
    (0, _currencyStore.currencyStore).data.forEach((currency)=>{
        currencies.push({
            title: currency[0],
            value: currency[0]
        });
    ...
    const title = (0, _myTitle.MyTitle)("Обмен валюты");
    const selectFrom = (0, _mySelector.MySelector)(currencies, "BTC", "swapFrom").selectMenu;
    const selectTo = (0, _mySelector.MySelector)(currencies, "ETH", "swapTo").selectMenu;
    const input = (0, _myInput.MyInput)("Введите сумму");
    const swap = (0, _myButton.MyButton)("Обменять");
    from.textContent = "Из";
    to.textContent = "в";
    ...
    swap.addEventListener("click", async (e)=>{
        ...
        if (input.value === "") {
            ...
            const newCurrencyUser = await (0, _swapCurrency.swapCurrency)(from, to, sum);
            (0, _processingResp.processingResp)(newCurrencyUser, input);
        }
    });
...
},{"../../../UI/MyTitle/MyTitle":"kQpK7","../../../UI/MySelector/MySelector":"5vydi","../../../UI/MyInput/MyInput":"5qHQO","../../../UI/MyButton/MyButton":"4PoHU","../../../store/currencyStore":"2u2TR","../api/swapCurrency":"crjat","./helpers/processingResp":"dLnwS","./bureau.scss":"hUTr9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5vydi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MySelector", ()=>MySelector);
var _select = require("../../assets/images/select");
var _myselectorScss = require("./myselector.scss");
const MySelector = (options = [], optionDefaultText, uniqClass = "uniq")=>{
    const selectMenu = document.createElement("div");
    const select = document.createElement("div");
    const optionDefault = document.createElement("span");
    const arrowSvg = document.createElement("svg");
    arrowSvg.innerHTML = (0, _select.IconArrow);
    ...
    arrOptions.forEach((option)=>{
        ...
        checkMarker.innerHTML = (0, _select.IconCheckMark);
...
},{"../../assets/images/select":"4IG5F","./myselector.scss":"gUXLp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4IG5F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IconArrow", ()=>IconArrow);
parcelHelpers.export(exports, "IconCheckMark", ()=>IconCheckMark);
const IconArrow = `<svg width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0.951904 0.5L5.9519 5.5L10.9519 0.5L0.951904 0.5Z" fill="#182233"/>
</svg>
`;
const IconCheckMark = `<svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.00003 11.17L1.83003 7.00003L0.410034 8.41003L6.00003 14L18 2.00003L16.59 0.590027L6.00003 11.17Z" fill="#182233"/>
</svg>
`;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gUXLp":[function() {},{}],"crjat":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "swapCurrency", ()=>swapCurrency);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../services/url.config");
var _spinner = require("../../../components/Spinner/Spinner");
const swapCurrency = async (fromValue, toValue, amountValue)=>{
    const spinner = (0, _spinner.Spinner)();
    document.body.append(spinner);
    try {
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/currency-buy`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Basic ${localStorage.getItem("token")}`
        ...
        if (data.payload) data.payload = Object.entries(data.payload);
        return data;
    } finally{
        document.querySelector(".wrapper-ring").remove();
    }
...
},{"axios":"jo6P5","../../../services/url.config":"aF1eV","../../../components/Spinner/Spinner":"aqKi8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dLnwS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "processingResp", ()=>processingResp);
var _myModal = require("../../../../UI/MyModal/MyModal");
var _currencyBlock = require("../../../../components/CurrencyBlock/CurrencyBlock");
const processingResp = (resp, field)=>{
    const modalView = document.querySelector(".block");
    if (resp.error === "") {
        const userCurrencyWrapper = document.querySelector(".currency__mycurrencyWrapper");
        const newBlock = (0, _currencyBlock.CurrencyBlock)("Ваши валюты", resp.payload);
        userCurrencyWrapper.replaceChild(newBlock, userCurrencyWrapper.children[0]);
        const modal = (0, _myModal.MyModal)("Транзакция прошла", "success");
        modalView.append(modal);
        field.value = "";
    } else if (resp.error === "Unknown currency code") {
        const modal = (0, _myModal.MyModal)("Передан неверный валютный код", "error");
        modalView.append(modal);
        field.value = "";
    } else if (resp.error === "Invalid amount") {
        const modal = (0, _myModal.MyModal)("Не указана сумма перевода, или она отрицательная", "error");
        modalView.append(modal);
        field.value = "";
    } else if (resp.error === "Not enough currency") {
        const modal = (0, _myModal.MyModal)("На валютном счёте списания нет средств", "error");
        modalView.append(modal);
        field.value = "";
    } else if (resp.error === "Overdraft prevented") {
        const modal = (0, _myModal.MyModal)("Попытка перевести больше, чем доступно на счёте списания", "error");
        modalView.append(modal);
        field.value = "";
    } else {
        const modal = (0, _myModal.MyModal)("Упс... Попробуйте позже", "error");
...
},{"../../../../UI/MyModal/MyModal":"squGM","../../../../components/CurrencyBlock/CurrencyBlock":"cCZlT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hUTr9":[function() {},{}],"lY5z9":[function() {},{}],"fRYv2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "accountIdPage", ()=>accountIdPage);
var _header = require("../components/Header/Header");
var _navbar = require("../components/Navbar/Navbar");
var _accountId = require("../modules/AccountId/AccountId");
var _myViewModal = require("../UI/MyViewModal/MyViewModal");
const accountIdPage = async ()=>{
    const navbar = (0, _navbar.Navbar)();
    const header = (0, _header.Header)(navbar);
    const main = await (0, _accountId.AccountId)();
    document.body.append(header, main);
    document.body.append((0, _myViewModal.MyViewModal)());
};

},{"../components/Header/Header":"8iwn3","../components/Navbar/Navbar":"2oTCt","../modules/AccountId/AccountId":"8maDA","../UI/MyViewModal/MyViewModal":"1z50T","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8maDA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AccountId", ()=>AccountId);
var _myContainer = require("../../UI/MyContainer/MyContainer");
var _titleBlock = require("../../components/TitleBlock/TitleBlock");
var _getAccountDetails = require("./api/getAccountDetails");
var _transferBlock = require("./TransferBlock/TransferBlock");
var _historyBlock = require("./HistoryBlock/HistoryBlock");
var _barChart = require("../../components/BarChart/BarChart");
var _index = require("../../assets/images/account/index");
var _accountBlock = require("../../components/AccountBlock/AccountBlock");
var _accountidScss = require("./accountid.scss");
const AccountId = async ()=>{
    const data = await (0, _getAccountDetails.getAccountDetails)();
    const { account , balance , transactions  } = data?.payload;
    const main = document.createElement("main");
    const container = (0, _myContainer.MyContainer)();
    const accountIdWrapper = document.createElement("div");
    const barChart = (0, _barChart.BarChart)(account, balance, transactions, 6);
    const transferBlock = (0, _transferBlock.TransferBlock)(account);
    const history = (0, _historyBlock.HistoryBlock)(transactions, account, 10);
    const transferWrapper = document.createElement("div");
    const svgArrow = document.createElement("svg");
    svgArrow.innerHTML = (0, _index.IconArrow);
    const titleBlock = (0, _titleBlock.TitleBlock)("Просмотр счёта", "Вернуться назад", svgArrow, "/account");
    const accountBlock = (0, _accountBlock.AccountBlock)(data);
...
},{"../../UI/MyContainer/MyContainer":"jpOMq","../../components/TitleBlock/TitleBlock":"b4i7M","./api/getAccountDetails":"lFjcK","./TransferBlock/TransferBlock":"eYIJd","./HistoryBlock/HistoryBlock":"cDQ67","../../components/BarChart/BarChart":"722cj","../../assets/images/account/index":"kgust","../../components/AccountBlock/AccountBlock":"iBENU","./accountid.scss":"l8cN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b4i7M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _myTitle = require("../../UI/MyTitle/MyTitle");
var _myButton = require("../../UI/MyButton/MyButton");
var _titleblockScss = require("./titleblock.scss");
const TitleBlock = (h1, btnTitle, svg, btnPath)=>{
    const block = document.createElement("div");
    const title = (0, _myTitle.MyTitle)(h1);
    const btnBack = (0, _myButton.MyButton)(btnTitle, "button", svg);
    btnBack.classList.add("btnBack");
    block.classList.add("titleWrapper");
    btnBack.addEventListener("click", ()=>{
        (0, _index.router).navigate(btnPath);
    });
    block.append(title, btnBack);
    return block;
};

},{"../../index":"8lqZg","../../UI/MyTitle/MyTitle":"kQpK7","../../UI/MyButton/MyButton":"4PoHU","./titleblock.scss":"8ElNf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8ElNf":[function() {},{}],"lFjcK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAccountDetails", ()=>getAccountDetails);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../services/url.config");
var _spinner = require("../../../components/Spinner/Spinner");
var _accountIdStore = require("../../../store/accountIdStore");
const getAccountDetails = async ()=>{
    const spinner = (0, _spinner.Spinner)();
    document.body.append(spinner);
    try {
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/account/${(0, _accountIdStore.accountIdStore).id || window.location.pathname.slice(9)}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Basic ${localStorage.getItem("token")}`
...
},{"axios":"jo6P5","../../../services/url.config":"aF1eV","../../../components/Spinner/Spinner":"aqKi8","../../../store/accountIdStore":"88s5M","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"88s5M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "accountIdStore", ()=>accountIdStore);
const accountIdStore = {
    id: null
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eYIJd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TransferBlock", ()=>TransferBlock);
var _myButton = require("../../../UI/MyButton/MyButton");
var _myInput = require("../../../UI/MyInput/MyInput");
var _myTitle = require("../../../UI/MyTitle/MyTitle");
var _account = require("../../../assets/images/account");
var _historyBlock = require("../HistoryBlock/HistoryBlock");
var _tooltip = require("../Tooltip/Tooltip");
var _transferFunds = require("../api/transferFunds");
var _requestStatus = require("../helpers/requestStatus");
var _setLocalStorageAccount = require("../helpers/setLocalStorageAccount");
var _transferblockScss = require("./transferblock.scss");
const TransferBlock = (id)=>{
    const transfer = document.createElement("form");
    const svg = document.createElement("svg");
    svg.innerHTML = (0, _account.IconMail);
    const title = (0, _myTitle.MyTitle)("Новый перевод");
    ...
    const otherAccountInput = (0, _myInput.MyInput)("Номер счёта получателя");
    const sumWrapper = document.createElement("div");
    const sumTitle = document.createElement("span");
    const sumInput = (0, _myInput.MyInput)("Сумма перевода");
    const btnSend = (0, _myButton.MyButton)("Отправить", "button", svg);
    ...
    otherAccountInput.onfocus = ()=>{
        const tooltip = (0, _tooltip.Tooltip)(otherAccountInput);
    ...
    document.body.addEventListener("click", (e)=>{
        ...
        if (e.target !== tooltip && e.target !== input && tooltip && e.target !== descr) tooltip.remove();
    });
    btnSend.addEventListener("click", async (e)=>{
        ...
        if (validateSum && validateOtherAccount) {
            const data = await (0, _transferFunds.transferFunds)(id, otherAccountInput.value, sumInput.value);
            const statusProcessing = (0, _requestStatus.requestStatus)(data.error);
            if (statusProcessing) {
                const transactions = data?.payload?.transactions;
                const currentHistory = document.querySelector(".history");
                const newHistory = (0, _historyBlock.HistoryBlock)(transactions, id);
                currentHistory.replaceWith(newHistory);
                (0, _setLocalStorageAccount.setLocalStorageAccount)(otherAccountInput.value);
            }
            sumInput.value = "";
            otherAccountInput.value = "";
            validateSum = false;
...
},{"../../../UI/MyButton/MyButton":"4PoHU","../../../UI/MyInput/MyInput":"5qHQO","../../../UI/MyTitle/MyTitle":"kQpK7","../../../assets/images/account":"kgust","../HistoryBlock/HistoryBlock":"cDQ67","../Tooltip/Tooltip":"7gZ3b","../api/transferFunds":"wFdCo","../helpers/requestStatus":"5WCAA","../helpers/setLocalStorageAccount":"1DwBc","./transferblock.scss":"1X9dv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kgust":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IconPlus", ()=>IconPlus);
parcelHelpers.export(exports, "IconArrow", ()=>IconArrow);
parcelHelpers.export(exports, "IconMail", ()=>IconMail);
const IconPlus = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 4.00001L12 12M12 12L12 20M12 12L20 12M12 12L4 12" stroke="white" stroke-width="2"/>
</svg>
`;
const IconArrow = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.83 11L11.41 7.41L10 6L4 12L10 18L11.41 16.59L7.83 13H20V11H7.83Z" fill="white"/>
</svg>
`;
const IconMail = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cDQ67":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "HistoryBlock", ()=>HistoryBlock);
var _ = require("../../..");
var _myTitle = require("../../../UI/MyTitle/MyTitle");
var _correctDate = require("../helpers/correctDate");
var _historyblockScss = require("./historyblock.scss");
const HistoryBlock = (transactions = [], id = null, count)=>{
    ...
    const title = (0, _myTitle.MyTitle)("История переводов");
    history.classList.add("history");
    title.classList.add("history__title");
    history.addEventListener("click", ()=>{
        (0, _.router).navigate(`account/${id}/transactions-history`);
    });
...
function createFieldsTable(transactions, table, id) {
    transactions.forEach((transaction)=>{
        ...
        tdDate.textContent = (0, _correctDate.correctDate)(transaction.date);
        tr.append(tdFrom, tdTo, tdAmount, tdDate);
        table.append(tr);
    });
}

},{"../../..":"8lqZg","../../../UI/MyTitle/MyTitle":"kQpK7","../helpers/correctDate":"52X87","./historyblock.scss":"45ZPg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"52X87":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "correctDate", ()=>correctDate);
const months = [
    "января",
    "февраля",
    "марта",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"45ZPg":[function() {},{}],"7gZ3b":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./tooltip.scss":"eXeYb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXeYb":[function() {},{}],"wFdCo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "transferFunds", ()=>transferFunds);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../services/url.config");
var _spinner = require("../../../components/Spinner/Spinner");
const transferFunds = async (fromValue, toValue, amountValue)=>{
    const spinner = (0, _spinner.Spinner)();
    document.body.append(spinner);
    try {
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/transfer-funds`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Basic ${localStorage.getItem("token")}`
...
},{"axios":"jo6P5","../../../services/url.config":"aF1eV","../../../components/Spinner/Spinner":"aqKi8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5WCAA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "requestStatus", ()=>requestStatus);
var _myModal = require("../../../UI/MyModal/MyModal");
const requestStatus = (status)=>{
    const modalView = document.querySelector(".block");
    switch(status){
        case "Invalid account from":
            const modalFrom = (0, _myModal.MyModal)("Не указан адрес счёта списания, или этот счёт не принадлежит нам", "error");
            modalView.append(modalFrom);
            return false;
        case "Invalid account to":
            const modalTo = (0, _myModal.MyModal)("Не указан счёт зачисления, или этого счёта не существует", "error");
            modalView.append(modalTo);
            return false;
        case "Invalid amount":
            const modalAmount = (0, _myModal.MyModal)("Не указана сумма перевода, или она отрицательная", "error");
            modalView.append(modalAmount);
            return false;
        case "Overdraft prevented":
            const modalOverdraft = (0, _myModal.MyModal)("Вы попытались перевести больше денег, чем доступно на счёте списания", "error");
            modalView.append(modalOverdraft);
            return false;
        default:
            const modalSuccess = (0, _myModal.MyModal)("Транзакция прошла", "success");
            modalView.append(modalSuccess);
            return true;
    }
};

},{"../../../UI/MyModal/MyModal":"squGM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1DwBc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setLocalStorageAccount", ()=>setLocalStorageAccount);
const setLocalStorageAccount = (value)=>{
    const currentAccounts = JSON.parse(localStorage.getItem("otherAccounts"));
    if (!currentAccounts) localStorage.setItem("otherAccounts", JSON.stringify([
        value
    ]));
    else localStorage.setItem("otherAccounts", JSON.stringify([
        ...currentAccounts.filter((account)=>account !== value),
        value
    ]));
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1X9dv":[function() {},{}],"722cj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BarChart", ()=>BarChart);
parcelHelpers.export(exports, "BarChartDifference", ()=>BarChartDifference);
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
var _myTitle = require("../../UI/MyTitle/MyTitle");
var _balanceHistory = require("./helpers/balanceHistory");
var _balanceHistoryDifference = require("./helpers/balanceHistoryDifference");
var _ = require("../../");
var _barchartScss = require("./barchart.scss");
const BarChart = (id = "", balance = "Неизвестно", transactions = [], current)=>{
    const barChart = document.createElement("div");
    const title = (0, _myTitle.MyTitle)("Динамика баланса");
    const arrBalanceHistory = (0, _balanceHistory.balanceHistory)(transactions, current, id);
    ...
    (0, _autoDefault.default).defaults.font.size = 15;
    (0, _autoDefault.default).defaults.color = "#000";
    (0, _autoDefault.default).defaults.font.weight = 700;
...
const BarChartDifference = (id = "", balance = "Неизвестно", transactions = [], current)=>{
    const barChart = document.createElement("div");
    const title = (0, _myTitle.MyTitle)("Соотношение входящих исходящих транзакций");
    const { datePlus , dateMinus  } = (0, _balanceHistoryDifference.balanceHistoryDifference)(transactions, current, id);
...
},{"chart.js/auto":"d8NN9","../../UI/MyTitle/MyTitle":"kQpK7","./helpers/balanceHistory":"etlL1","./helpers/balanceHistoryDifference":"9TA0F","../../":"8lqZg","./barchart.scss":"gChIw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"etlL1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "balanceHistory", ()=>balanceHistory);
const months = [
    "январь",
    "февраль",
    "март",
...
const balanceHistory = (transactions = [], current, id)=>{
    const arrDate = [];
    const arrMonths = [];
    ...
    requiredMonths.forEach((current)=>{
        ...
        arrMonths.forEach((month)=>{
            if (month.month === current) obj.amount = month.amount;
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9TA0F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "balanceHistoryDifference", ()=>balanceHistoryDifference);
const months = [
    "январь",
    "февраль",
    "март",
...
const balanceHistoryDifference = (transactions = [], current, id)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gChIw":[function() {},{}],"iBENU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AccountBlock", ()=>AccountBlock);
var _accountblockScss = require("./accountblock.scss");
const AccountBlock = (data)=>{
    ...
    if (data?.payload?.balance === 0 || data?.payload?.balance) balanceCount.textContent = `${data?.payload?.balance} ₽`;
...
},{"./accountblock.scss":"bKR4c","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bKR4c":[function() {},{}],"l8cN9":[function() {},{}],"7jREJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "accountPage", ()=>accountPage);
var _header = require("../components/Header/Header");
var _navbar = require("../components/Navbar/Navbar");
var _account = require("../modules/Account/Account");
var _myViewModal = require("../UI/MyViewModal/MyViewModal");
const accountPage = async ()=>{
    const navbar = (0, _navbar.Navbar)("account");
    const header = (0, _header.Header)(navbar);
    const account = await (0, _account.Account)();
    document.body.append(header, account);
    document.body.append((0, _myViewModal.MyViewModal)());
};

},{"../components/Header/Header":"8iwn3","../components/Navbar/Navbar":"2oTCt","../modules/Account/Account":"jJG9Q","../UI/MyViewModal/MyViewModal":"1z50T","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jJG9Q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Account", ()=>Account);
var _sortBy = require("./helpers/sortBy");
var _myContainer = require("../../UI/MyContainer/MyContainer");
var _mySelector = require("../../UI/MySelector/MySelector");
var _myTitle = require("../../UI/MyTitle/MyTitle");
var _myButton = require("../../UI/MyButton/MyButton");
var _selectConfig = require("../../services/select.config");
var _index = require("../../assets/images/account/index");
var _accountCard = require("./AccountCard/AccountCard");
var _getAccountUser = require("./api/getAccountUser");
var _createNewAccount = require("./api/createNewAccount");
var _myModal = require("../../UI/MyModal/MyModal");
var _accountScss = require("./account.scss");
const Account = async ()=>{
    const currentAccount = await (0, _getAccountUser.getAccountUser)();
    const main = document.createElement("main");
    const wrapper = document.createElement("div");
    const accounts = document.createElement("div");
    const svgPlus = document.createElement("svg");
    svgPlus.innerHTML = (0, _index.IconPlus);
    const title = (0, _myTitle.MyTitle)("Ваши счета");
    const btnAddAccount = (0, _myButton.MyButton)("Создать новый счёт", "button", svgPlus);
    const { selectMenu , arrOptions  } = (0, _mySelector.MySelector)((0, _selectConfig.sortSelect), "Сортировка");
    const container = (0, _myContainer.MyContainer)();
    if (currentAccount.error === "") currentAccount.payload.forEach((account)=>{
        const card = (0, _accountCard.AccountCard)(account.account, account.balance, account.transactions);
    ...
    arrOptions.forEach((option)=>{
        option.addEventListener("click", async (e)=>{
            if (e.target.dataset.sort == "balance") {
                const sortAccounts = await (0, _getAccountUser.getAccountUser)();
                const sortCards = (0, _sortBy.sortByBalance)(sortAccounts.payload);
                accounts.innerHTML = "";
            ...
            if (e.target.dataset.sort == "number") {
                const sortAccounts = await (0, _getAccountUser.getAccountUser)();
                const sortCards = (0, _sortBy.sortByNumber)(sortAccounts.payload);
                accounts.innerHTML = "";
                sortCards.forEach((account)=>{
                    const card = (0, _accountCard.AccountCard)(account.account, account.balance, account.transactions);
                    accounts.append(card);
            ...
            if (e.target.dataset.sort == "transaction") {
                const sortAccounts = await (0, _getAccountUser.getAccountUser)();
                const sortCards = (0, _sortBy.sortByTransactions)(sortAccounts.payload);
                accounts.innerHTML = "";
                sortCards.forEach((account)=>{
                    const card = (0, _accountCard.AccountCard)(account.account, account.balance, account.transactions);
                    accounts.append(card);
    ...
    btnAddAccount.addEventListener("click", async ()=>{
        const otherCard = await (0, _createNewAccount.createNewAccount)();
        if (otherCard.status === 200) {
            const card = (0, _accountCard.AccountCard)(otherCard.account, otherCard.balance, otherCard.date);
            accounts.append(card);
            const modalView = document.querySelector(".block");
            const modal = (0, _myModal.MyModal)("Счет был создан", "success");
            modalView.append(modal);
        } else {
            const modalView = document.querySelector(".block");
            const modal = (0, _myModal.MyModal)("Упс... Попробуйте позже", "error");
...
},{"./helpers/sortBy":"8PWcz","../../UI/MyContainer/MyContainer":"jpOMq","../../UI/MySelector/MySelector":"5vydi","../../UI/MyTitle/MyTitle":"kQpK7","../../UI/MyButton/MyButton":"4PoHU","../../services/select.config":"haJxH","../../assets/images/account/index":"kgust","./AccountCard/AccountCard":"jyWuC","./api/getAccountUser":"9btQ6","./api/createNewAccount":"6ehsf","../../UI/MyModal/MyModal":"squGM","./account.scss":"2Ngys","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8PWcz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sortByBalance", ()=>sortByBalance);
parcelHelpers.export(exports, "sortByNumber", ()=>sortByNumber);
parcelHelpers.export(exports, "sortByTransactions", ()=>sortByTransactions);
const sortByBalance = (accounts)=>{
    return accounts.sort((a, b)=>b.balance - a.balance);
};
const sortByNumber = (accounts)=>{
    return accounts.sort((a, b)=>b.account - a.account);
};
const sortByTransactions = (accounts)=>{
    return accounts.sort((a, b)=>new Date(b.date) - new Date(a.date));
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"haJxH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sortSelect", ()=>sortSelect);
const sortSelect = [
    number = {
        title: "По номеру",
        value: "number"
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jyWuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AccountCard", ()=>AccountCard);
var _myButton = require("../../../UI/MyButton/MyButton");
var _correctDate = require("../helpers/correctDate");
var _ = require("../../..");
var _accountIdStore = require("../../../store/accountIdStore");
var _accountcardScss = require("./accountcard.scss");
const AccountCard = (account, balance, transaction)=>{
    const card = document.createElement("div");
    const btnOpen = (0, _myButton.MyButton)("Открыть");
    ...
    if (transaction.length) date.textContent = (0, _correctDate.correctDate)(transaction[transaction.length - 1].date);
    ...
    btnOpen.addEventListener("click", ()=>{
        document.body.innerHTML = "";
        (0, _accountIdStore.accountIdStore).id = account;
        (0, _.router).navigate(`/account/${account}`);
    });
...
},{"../../../UI/MyButton/MyButton":"4PoHU","../helpers/correctDate":"aMv2Z","../../..":"8lqZg","../../../store/accountIdStore":"88s5M","./accountcard.scss":"7AiiK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aMv2Z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "correctDate", ()=>correctDate);
const months = [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7AiiK":[function() {},{}],"9btQ6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAccountUser", ()=>getAccountUser);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../services/url.config");
var _spinner = require("../../../components/Spinner/Spinner");
const getAccountUser = async ()=>{
    ...
    document.body.append(spinner);
    try {
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/accounts`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Basic ${localStorage.getItem("token")}`
...
},{"axios":"jo6P5","../../../services/url.config":"aF1eV","../../../components/Spinner/Spinner":"aqKi8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6ehsf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createNewAccount", ()=>createNewAccount);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../services/url.config");
var _spinner = require("../../../components/Spinner/Spinner");
const createNewAccount = async ()=>{
    ...
    document.body.append(spinner);
    try {
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/create-account`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Basic ${localStorage.getItem("token")}`
...
},{"axios":"jo6P5","../../../services/url.config":"aF1eV","../../../components/Spinner/Spinner":"aqKi8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Ngys":[function() {},{}],"9SwD6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ModalOops", ()=>ModalOops);
var _myModal = require("../../UI/MyModal/MyModal");
const ModalOops = ()=>{
    const modal = (0, _myModal.MyModal)("Упс... Попробуйте позже", "error");
    const modalView = document.querySelector(".block");
...
},{"../../UI/MyModal/MyModal":"squGM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fsqSO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "transactionsHistoryPage", ()=>transactionsHistoryPage);
var _myViewModal = require("../UI/MyViewModal/MyViewModal");
var _header = require("../components/Header/Header");
var _navbar = require("../components/Navbar/Navbar");
var _transactions = require("../modules/Transactions/Transactions");
const transactionsHistoryPage = async ()=>{
    const navbar = (0, _navbar.Navbar)();
    const header = (0, _header.Header)(navbar);
    const main = await (0, _transactions.Transactions)();
    document.body.append(header, main);
    document.body.append((0, _myViewModal.MyViewModal)());
};

},{"../UI/MyViewModal/MyViewModal":"1z50T","../components/Header/Header":"8iwn3","../components/Navbar/Navbar":"2oTCt","../modules/Transactions/Transactions":"1kmLr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1kmLr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _titleBlock = require("../../components/TitleBlock/TitleBlock");
var _accountBlock = require("../../components/AccountBlock/AccountBlock");
var _historyBlock = require("../AccountId/HistoryBlock/HistoryBlock");
var _barChart = require("../../components/BarChart/BarChart");
var _getTransactionsDetails = require("./api/getTransactionsDetails");
var _index = require("../../assets/images/account/index");
var _transactionsScss = require("./transactions.scss");
const Transactions = async ()=>{
    const data = await (0, _getTransactionsDetails.getTransactionsDetails)();
    const { account , balance , transactions  } = data?.payload;
    const barChart = (0, _barChart.BarChart)(account, balance, transactions, 12);
    const barChartDifference = (0, _barChart.BarChartDifference)(account, balance, transactions, 12);
    const main = document.createElement("main");
    const container = (0, _myContainer.MyContainer)();
    const transactionsWrapper = document.createElement("div");
    const svgArrow = document.createElement("svg");
    svgArrow.innerHTML = (0, _index.IconArrow);
    const titleBlock = (0, _titleBlock.TitleBlock)("История баланса", "Вернуться назад", svgArrow, `/account/${account}`);
    const accountBlock = (0, _accountBlock.AccountBlock)(data);
    const history = (0, _historyBlock.HistoryBlock)(transactions, account, 10);
...
},{"../..":"8lqZg","../../UI/MyContainer/MyContainer":"jpOMq","../../components/TitleBlock/TitleBlock":"b4i7M","../../components/AccountBlock/AccountBlock":"iBENU","../AccountId/HistoryBlock/HistoryBlock":"cDQ67","../../components/BarChart/BarChart":"722cj","./api/getTransactionsDetails":"eYplC","../../assets/images/account/index":"kgust","./transactions.scss":"il2dA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eYplC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getTransactionsDetails", ()=>getTransactionsDetails);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _urlConfig = require("../../../services/url.config");
var _spinner = require("../../../components/Spinner/Spinner");
...
const getTransactionsDetails = async ()=>{
    ...
    try {
        ...
        const resp = await (0, _axiosDefault.default)(`${(0, _urlConfig.baseUrl)}/account/${(0, _accountIdStore.accountIdStore).id || id}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Basic ${localStorage.getItem("token")}`
...
},{"axios":"jo6P5","../../../services/url.config":"aF1eV","../../../components/Spinner/Spinner":"aqKi8","../../../store/accountIdStore":"88s5M","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"il2dA":[function() {},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequiree8ef")
